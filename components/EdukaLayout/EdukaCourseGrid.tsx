          ...
          {items.map((item, idx) => (
            ...
            >
              ...
              <div className="relative h-60 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded text-sm font-bold text-primary">
                  {item.category}
                </div>
              </div>
              ...
              <div className="p-8 flex flex-col flex-grow">
                {item.meta && (
                  <div className="flex items-center text-sm text-slate-500 font-medium mb-3">
                    <svg className="w-4 h-4 mr-2 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    {item.meta}
                  </div>
                )}
                ...
                <div className="pt-6 border-t border-slate-100 mt-auto">
                  <Link href={item.link} className="inline-flex items-center text-secondary font-bold group-hover:text-primary transition-colors">
                    Know Details
