    ...
    <div className="bg-white">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {chooseItems.map((item, idx) => (
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white text-sm font-extrabold shadow-sm flex-shrink-0 group-hover:scale-110 transition-transform duration-200">
                    ✓
                  </div>
      ...
      <section className="relative pt-[50px] pb-20 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
        <div className="max-w-5xl mx-auto relative z-10">
          <motion.div
            {...fadeUp(0)}
            className="relative bg-gradient-to-br from-primary via-[#145c4e] to-primary rounded-[32px] p-8 sm:p-14 text-center space-y-6 overflow-hidden shadow-[0_20px_60px_rgba(12,74,65,0.25)]"
          >
            {/* Mesh shimmer */}
            <div
