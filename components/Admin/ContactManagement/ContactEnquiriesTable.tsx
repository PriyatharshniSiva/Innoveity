      ...
      <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
        ...
        <div className="flex gap-2">
          ...
          <div className="relative">
            ...
            <input type="text" placeholder="Search..." className="pl-9 pr-4 py-2 border border-slate-200 rounded-lg text-sm w-48 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" />
          </div>
        </div>
      </div>
            ...
            {enquiries.map((enq) => (
              <tr key={enq.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                ...
                <td className="py-3 px-4 text-right">
                  <button onClick={() => openDrawer("enquiry", enq.id)} className="p-1.5 text-slate-400 hover:text-primary hover:bg-primary/10 rounded-lg transition-colors inline-flex">
