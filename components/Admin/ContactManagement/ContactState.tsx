...
const initialOffices: OfficeItem[] = [
  { id: "1", name: "Main Office", address: "No:11 Ritherdon Avenue, Ritherdon Road", city: "Vepery, Chennai", pincode: "600007", branchType: "Headquarters", color: "var(--color-brand-primary)", order: 1 },
