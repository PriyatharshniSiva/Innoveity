...
export default function ContactLivePreview() {
  ...
  return (
    <div className="bg-slate-50 h-[800px] rounded-3xl border-4 border-slate-200 overflow-y-auto custom-scrollbar relative shadow-2xl">
      ...
      <div className="origin-top scale-[0.8] w-[125%] mb-[-20%] selection:bg-primary selection:text-white pb-20">
        ...
        <section className="relative py-20 px-4 overflow-hidden bg-white border-b border-slate-100 text-center">
          ...
          <h1 className="text-4xl sm:text-[56px] font-black text-secondary tracking-tight mb-6 leading-[1.1]">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary">Chennai Tamil Nadu</span>
          </h1>
        ...
        <section className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-3 bg-white p-8 md:p-12 rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.04)] border border-slate-100">
            <h2 className="text-3xl font-black text-secondary mb-2">Get Free Consultation</h2>
            ...
            <div className="space-y-5">
              ...
              <button disabled className="w-full bg-primary text-white font-black text-[17px] py-5 rounded-[20px] shadow-[0_8px_20px_rgba(22,163,74,0.2)]">Submit Request</button>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="bg-white p-7 rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-slate-100 flex items-center gap-6">
              <div className="bg-primary/10 p-4 rounded-[16px] text-primary">
                <Phone className="w-7 h-7" />
              </div>
              <div>
                <h3 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-1">Call Us</h3>
                <p className="text-xl font-black text-secondary">{settings.phonePrimary}</p>
              </div>
            </div>
            ...
            <div className="bg-white p-7 rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-slate-100 flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-[17px] font-bold text-secondary mb-0.5">{settings.emailPrimary}</p>
                <p className="text-[17px] font-bold text-secondary">{settings.emailSecondary}</p>
              </div>
            </div>
            ...
            <div className="bg-white p-7 rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-slate-100 flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-[16px] font-bold text-secondary mb-0.5">{settings.hoursWeekday}</p>
                <p className="text-[16px] font-bold text-secondary">{settings.hoursWeekend}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {offices.map(office => (
            <div key={office.id} className="bg-white p-8 rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.03)] border border-slate-100 border-t-4 transition-all" style={{ borderTopColor: office.color }}>
              ...
              <h3 className="text-xl font-black text-secondary mb-2 flex items-center gap-2">
