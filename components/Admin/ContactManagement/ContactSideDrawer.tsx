          ...
          >
              ...
              {editingType === "office" && (
                <>
                  <div>
                    ...
                    <input type="text" name="name" value={officeData.name || ""} onChange={handleOfficeChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-semibold text-slate-700 mb-2">Branch Type</label>
                      <select name="branchType" value={officeData.branchType || "Branch"} onChange={handleOfficeChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white">
                    ...
                    <div>
                      ...
                      <input type="color" name="color" value={officeData.color || "var(--color-brand-primary)"} onChange={handleOfficeChange} className="w-full h-12 rounded-xl border border-slate-200 cursor-pointer p-1" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Full Address</label>
                    <textarea name="address" value={officeData.address || ""} onChange={handleOfficeChange} rows={3} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none" />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-semibold text-slate-700 mb-2">City</label>
                      <input type="text" name="city" value={officeData.city || ""} onChange={handleOfficeChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-slate-700 mb-2">Pincode</label>
                      <input type="text" name="pincode" value={officeData.pincode || ""} onChange={handleOfficeChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
                    </div>
                  </div>
                </>
              )}
                ...
                <>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input type="text" name="phonePrimary" value={settingsData.phonePrimary} onChange={handleSettingsChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 pt-4">
                    ...
                    <div>
                      ...
                      <input type="email" name="emailPrimary" value={settingsData.emailPrimary} onChange={handleSettingsChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-slate-700 mb-2">Secondary / Support Email</label>
                      <input type="email" name="emailSecondary" value={settingsData.emailSecondary} onChange={handleSettingsChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 pt-4">
                    ...
                    <div>
                      ...
                      <input type="text" name="hoursWeekday" value={settingsData.hoursWeekday} onChange={handleSettingsChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-slate-700 mb-2">Weekend Hours</label>
                      <input type="text" name="hoursWeekend" value={settingsData.hoursWeekend} onChange={handleSettingsChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
                    </div>
                  </div>
                </>
              )}
            ...
            {editingType === "enquiry" && (
              <div className="p-6 border-t border-slate-100 bg-white grid grid-cols-2 gap-3">
                <a href={`mailto:${enquiryData?.email}`} className="w-full py-3.5 bg-primary hover:bg-primary/90 text-white font-bold rounded-xl shadow-[0_4px_14px_0_rgba(24,93,70,0.39)] transition-all flex items-center justify-center">
                  Reply Email
                </a>
