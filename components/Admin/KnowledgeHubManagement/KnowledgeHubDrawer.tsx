              ...
              {activeTab === "content" && (
                <div className="space-y-6 animate-in fade-in duration-300">
                  <div>
                    ...
                    <input type="text" value={localData.title} onChange={e => setLocalData({...localData, title: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-white transition-all text-sm font-medium" placeholder="e.g. The Future of EdTech" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Short Description</label>
                    <textarea rows={3} value={localData.desc} onChange={e => setLocalData({...localData, desc: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-white transition-all text-sm font-medium resize-none" placeholder="A brief impactful summary..." />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Full Article Content</label>
                    <div className="border border-slate-200 rounded-xl bg-white overflow-hidden focus-within:ring-2 focus-within:ring-[#185D46]/20 focus-within:border-[#185D46] transition-all">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" value={localData.instructor} onChange={e => setLocalData({...localData, instructor: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-white transition-all text-sm font-medium" placeholder="e.g. John Doe" />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-slate-700 mb-2">Category Dropdown</label>
                      <select value={localData.level} onChange={e => setLocalData({...localData, level: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-white transition-all text-sm font-medium">
                ...
                <div className="space-y-6 animate-in fade-in duration-300">
                  <div>
                    ...
                    <div className="border-2 border-dashed border-slate-200 rounded-2xl p-8 flex flex-col items-center justify-center bg-white hover:bg-slate-50 transition-colors cursor-pointer group mb-4">
                      <div className="w-16 h-16 bg-[#185D46]/10 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    ...
                    <input type="text" value={localData.image} onChange={e => setLocalData({...localData, image: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-white transition-all text-sm font-medium" placeholder="https://..." />
                ...
                <div className="space-y-6 animate-in fade-in duration-300">
                  ...
                  <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                    ...
                    <div>
                      ...
                      <input type="text" value={localData.seoTitle} onChange={e => setLocalData({...localData, seoTitle: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-slate-50 transition-all text-sm font-medium" placeholder="Optimal length is 50-60 chars" />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-slate-700 mb-2">SEO Meta Description</label>
                      <textarea rows={3} value={localData.seoDescription} onChange={e => setLocalData({...localData, seoDescription: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-slate-50 transition-all text-sm font-medium resize-none" placeholder="Optimal length is 150-160 chars" />
                    </div>
                    <div>
                      ...
                      <div className="flex">
                        ...
                        <input type="text" value={localData.slug} onChange={e => setLocalData({...localData, slug: e.target.value})} className="flex-1 px-4 py-3 rounded-r-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-slate-50 transition-all text-sm font-medium" placeholder="article-url-slug" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div>
                        ...
                        <input type="text" value={localData.readTime} onChange={e => setLocalData({...localData, readTime: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-slate-50 transition-all text-sm font-medium" placeholder="e.g. 5 min read" />
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-slate-700 mb-2">Publish Date</label>
                        <input type="text" value={localData.nextBatch} onChange={e => setLocalData({...localData, nextBatch: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#185D46]/20 focus:border-[#185D46] bg-slate-50 transition-all text-sm font-medium" placeholder="MM/DD/YYYY" />
                      </div>
                    </div>
                    <div>
            ...
            <div className="p-6 border-t border-slate-100 bg-white flex flex-col sm:flex-row items-center justify-between gap-4 mt-auto">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-8 py-2.5 rounded-xl font-bold bg-[#185D46] text-white hover:bg-[#124634] transition-colors shadow-lg shadow-[#185D46]/20 flex-1 sm:flex-none"
                >
