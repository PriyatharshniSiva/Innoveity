          ...
          {activeSection === "journey" && (
            ...
            >
              <div className="p-6 space-y-4">
                    ...
                    <div className="flex-1 space-y-3">
                      <div className="flex gap-4">
                        <input 
                          ...
                          className="w-32 px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white"
                        />
                        <input 
                          type="text" value={step.title} onChange={(e) => handleJourneyChange(step.id, "title", e.target.value)}
                          placeholder="Title"
                          className="flex-1 px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white"
                        />
                      </div>
                      <textarea
                        value={step.description} onChange={(e) => handleJourneyChange(step.id, "description", e.target.value)}
                        placeholder="Description" rows={2}
                        className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white resize-none"
                      />
                    </div>
                ...
                <button className="w-full py-3 border-2 border-dashed border-slate-200 rounded-xl text-slate-500 font-semibold flex items-center justify-center hover:border-accent hover:text-accent transition-colors bg-slate-50 hover:bg-accent/5">
            ...
            <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="border-t border-slate-100">
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <textarea rows={3} value={missionVision.mission} onChange={e => setMissionVision({...missionVision, mission: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-slate-50 focus:bg-white resize-none" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">Our Vision</label>
                  <textarea rows={3} value={missionVision.vision} onChange={e => setMissionVision({...missionVision, vision: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-slate-50 focus:bg-white resize-none" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">Our Values</label>
                  <textarea rows={3} value={missionVision.values} onChange={e => setMissionVision({...missionVision, values: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-slate-50 focus:bg-white resize-none" />
                </div>
              </div>
            </motion.div>
          )}
