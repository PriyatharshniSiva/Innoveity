  ...
  const eduCards = [
    {
      ...
      description: "Empower educators with modern methodologies, AICTE-aligned programs, and effective NEP 2020 integration."
    },
    {
      ...
      description: "Enhance employability through aptitude coaching, technical certifications, and targeted soft skills workshops."
    },
    {
      ...
      description: "Boost placement rates by up to 85% with our industry-connect programs and specialized interview prep."
    }
  ];
  ...
  const indCards = [
    {
      ...
      description: "Empower your workforce with customized L&D programs, leadership training, and technical upskilling with measurable ROI."
    },
    {
      ...
      description: "Navigate sustainability reporting, carbon footprint analysis, and CSR compliance with our comprehensive ESG frameworks."
    },
    {
      title: "Legal Audits",
      icon: (
      ...
      description: "Ensure full compliance with industry regulations, labor laws, and corporate governance through expert auditing services."
    },
    {
      ...
      description: "Drive digital transformation with innovative technology consulting, process automation, and tailored IT solutions."
    }
  ];
  ...
  const commCards = [
    {
      ...
      description: "Join interactive sessions led by industry experts covering emerging technologies, leadership, and sustainability."
    },
    {
      ...
      description: "Participate in hackathons and coding challenges designed to foster innovation and practical problem-solving."
    },
    {
      ...
      description: "Engage in impactful CSR initiatives that support local communities through education and digital literacy."
    }
  ];
    ...
    <div className="min-h-screen bg-white text-[#0F172A] selection:bg-[#185D46] selection:text-white">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 pt-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            Our <span className="text-[#185D46]">Services</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Comprehensive solutions designed to bridge the gap between education and industry, fostering growth, innovation, and sustainable development.
          </motion.p>
        </div>
      </section>
        ...
        >
          <section className="bg-gradient-to-br from-[#185D4610]/30 to-[#f0f9ff]/20 backdrop-blur-xl rounded-[24px] p-8 md:p-12 border border-[#185D4630] border-l-[6px] border-l-[#185D46] shadow-[0_20px_50px_rgba(12,74,65,0.05)] relative overflow-hidden group">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#185D46] mb-6 tracking-tight leading-tight">
              Comprehensive Training Solutions for Tamil Nadu
            </h2>
            
            <p className="text-lg text-slate-600 mb-10 leading-relaxed font-medium">
              INNOVEITY offers specialized training programs for educational institutions, corporate organizations, and communities across Tamil Nadu. Our services include faculty development, student placement training, corporate L&D solutions, ESG consulting, and community outreach programs—all delivered by ISO-certified trainers with proven track records.
            </p>
      ...
      {[{ title: "For Educational Institutions", data: eduCards, bg: "bg-slate-50/50" }, 
        { title: "For Industries", data: indCards, bg: "bg-white" }, 
        { title: "For Communities", data: commCards, bg: "bg-slate-50/50" }].map((section, idx) => (
        <section key={idx} className={`py-24 px-4 sm:px-6 lg:px-8 ${section.bg} relative overflow-hidden`}>
          {idx === 1 && (
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div 
              ...
              whileInView="show"
              viewport={{ once: false, margin: "-50px" }}
              className={`grid grid-cols-1 md:grid-cols-2 ${section.data.length === 3 ? 'lg:grid-cols-3' : 'lg:grid-cols-4'} gap-8`}
            >
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed font-medium relative z-10">
              Whether you're an academic institution looking to upgrade your relevance or a corporate entity seeking elite talent, the bridge starts here.
            </p>
