      ...
      <section className="relative pt-12 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <motion.h1 
            ...
            className="text-5xl sm:text-6xl md:text-7xl font-black text-secondary mb-8 tracking-tight"
          >
            {data?.overview?.titleLine1 || "Our"} <span className="text-primary">{data?.overview?.titleHighlight || "Services"}</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="pt-8 pb-24 px-4 sm:px-6 lg:px-8 bg-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <motion.div 
            ...
            className="bg-secondary rounded-[32px] p-12 md:p-20 text-center shadow-[0_20px_50px_rgb(15,23,42,0.2)] border border-slate-800 relative overflow-hidden group"
          >
            {/* Interactive Glow inside CTA */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[300px] h-[300px] bg-primary rounded-full blur-[100px] opacity-20 group-hover:opacity-40 transition-opacity duration-700 pointer-events-none" />
            ...
            <Link href={data?.cta?.buttonLink || "/contact"}>
              <button className="relative z-10 group px-10 py-5 bg-accent text-secondary font-black text-lg rounded-xl shadow-lg shadow-accent/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-accent/40 overflow-hidden flex items-center justify-center mx-auto">
