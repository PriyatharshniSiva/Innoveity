      ...
      >
        ...
        <div className="text-center mb-24 max-w-4xl mx-auto">
          ...
          <motion.h1 variants={itemVariants} className="text-4xl md:text-5xl lg:text-[56px] font-black text-[#0F172A] leading-[1.1] mb-6 tracking-tight">
            Corporate Training & College Development<br className="hidden md:block" />
          ...
          <motion.p variants={itemVariants} className="text-[#475569] md:text-[19px] max-w-3xl mx-auto mb-16 leading-relaxed font-medium">
            Transform your institution with INNOVEITY's proven solutions. 2000+ students trained across
            50+ Tamil Nadu colleges, 85% placement improvement. Contact Chennai office for free
            consultation.
          </motion.p>
          ...
          <motion.div variants={containerVariants} className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { icon: <UserIcon className="w-6 h-6" />, value: "2000+", label: "Students" },
              { icon: <Building className="w-6 h-6" />, value: "50+", label: "Institutions" },
              { icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline><polyline points="16 7 22 7 22 13"></polyline></svg>, value: "85%", label: "Improvement" },
              { icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>, value: "100+", label: "Corporate" }
            ].map((stat, i) => (
              <motion.div 
                key={i} 
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-xl font-black text-[#0F172A]">+91 880 770 8818</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[17px] font-bold text-[#0F172A] mb-0.5">info@innoveity.com</p>
                <p className="text-[17px] font-bold text-[#0F172A]">admin@innoveity.com</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[16px] font-bold text-[#0F172A] mb-0.5">Mon - Fri: 9 AM - 6 PM</p>
                <p className="text-[16px] font-bold text-[#0F172A]">Saturday: 10 AM - 4 PM</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        >
          <div className="bg-white p-3 sm:p-4 rounded-[32px] sm:rounded-[40px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-slate-100 relative group overflow-hidden h-[450px]">
            <div className="w-full h-full rounded-[24px] sm:rounded-[32px] overflow-hidden relative">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.417387438497!2d80.2582846153664!3d13.08272919078347!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5265e3170425a7%3A0xc008f10ea82b4a!2sChennai!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
        ...
        >
          ...
          <motion.div 
            variants={itemVariants}
            whileHover={{ y: -8 }}
            className="bg-white p-8 rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgba(22,163,74,0.08)] border border-slate-100 border-t-4 border-t-transparent hover:border-t-[#185D46] transition-all duration-300 relative group"
          >
            <div className="w-12 h-12 bg-[#185D46]/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#185D46] group-hover:text-white text-[#185D46] transition-colors duration-300">
              <MapPin className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-black text-[#0F172A] mb-2 flex items-center gap-2">
              Main Office <span className="w-2 h-2 rounded-full bg-[#185D46]"></span>
            </h3>
            <div className="text-gray-500 font-medium space-y-1 mb-4">
              <p>No:11 Ritherdon Avenue, Ritherdon Road</p>
              <p>Vepery, Chennai - 600007</p>
              <p>Tamil Nadu, India</p>
            </div>
            <p className="text-[#185D46] font-bold text-sm tracking-wide uppercase">Headquarters</p>
          </motion.div>
          ...
          <motion.div 
            variants={itemVariants}
            whileHover={{ y: -8 }}
            className="bg-white p-8 rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgba(22,163,74,0.08)] border border-slate-100 border-t-4 border-t-transparent hover:border-t-[#3b82f6] transition-all duration-300 relative group"
          >
            <div className="w-12 h-12 bg-[#3b82f6]/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#3b82f6] group-hover:text-white text-[#3b82f6] transition-colors duration-300">
              <MapPin className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-black text-[#0F172A] mb-2 flex items-center gap-2">
              Branch Offices <span className="w-2 h-2 rounded-full bg-[#3b82f6]"></span>
            </h3>
            <div className="text-gray-500 font-medium space-y-2 mb-4">
              <p className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-slate-300"></span> Trichy Office</p>
              <p className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-slate-300"></span> Salem Office</p>
              <p className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-slate-300"></span> Tirunelveli</p>
              <p className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-slate-300"></span> Bangalore Office</p>
            </div>
          </motion.div>
          ...
          <motion.div 
            variants={itemVariants}
            whileHover={{ y: -8 }}
            className="bg-white p-8 rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgba(22,163,74,0.08)] border border-slate-100 border-t-4 border-t-transparent hover:border-t-[#a855f7] transition-all duration-300 relative group"
          >
            <div className="w-12 h-12 bg-[#a855f7]/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#a855f7] group-hover:text-white text-[#a855f7] transition-colors duration-300">
              <MapPin className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-black text-[#0F172A] mb-2 flex items-center gap-2">
              Research Center <span className="w-2 h-2 rounded-full bg-[#a855f7]"></span>
            </h3>
            <div className="text-gray-500 font-medium space-y-1 mb-4">
              <p>Anna University Atal Innovation Center</p>
              <p>Chennai - 600025</p>
            </div>
            <p className="text-[#a855f7] font-bold text-sm tracking-wide uppercase mt-6">Industry 4.0 & AI/ML</p>
          </motion.div>
