...
export default function CSR() {
  const metrics = [
    { label: "CO₂ Tons Reduced", value: "2500" }, // Modified slightly for the counter to work cleanly
    ...
    <div className="min-h-screen bg-slate-50 overflow-hidden selection:bg-[#185D46] selection:text-white pb-24">
      ...
      <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white border-b border-slate-100">
        ...
        <div className="text-center space-y-6 max-w-4xl mx-auto relative z-10">
          ...
          >
            Our commitment to creating positive social and environmental impact through sustainable business practices, community engagement, and responsible innovation.
          </motion.p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-black text-[#0F172A] tracking-tight">Key Initiatives</h2>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black !text-white tracking-tight relative z-10">Join Our Impact Journey</h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed font-medium relative z-10">
            Partner with INNOVEITY to implement ESG consulting or execute CSR projects that align under Schedule VII. Let's build a sustainable and equitable future together.
          </p>
