...
export default function UsersManagement() {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] text-center animate-in fade-in zoom-in duration-500">
      ...
      <h1 className="text-3xl font-black text-slate-800 tracking-tight">Users Management</h1>
      <p className="text-slate-500 mt-3 max-w-md">This module is currently under development. Soon you will be able to manage all users content directly from this beautiful interface.</p>
    </div>
  );
}
