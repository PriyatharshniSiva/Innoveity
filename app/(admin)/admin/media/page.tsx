...
export default function MediaManagement() {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] text-center animate-in fade-in zoom-in duration-500">
      ...
      <h1 className="text-3xl font-black text-slate-800 tracking-tight">Media Management</h1>
      <p className="text-slate-500 mt-3 max-w-md">This module is currently under development. Soon you will be able to manage all media content directly from this beautiful interface.</p>
    </div>
  );
}
