...
export default function ProfileManagement() {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] text-center animate-in fade-in zoom-in duration-500">
      ...
      <p className="text-slate-500 mt-3 max-w-md">This module is currently under development. Soon you will be able to manage all profile content directly from this beautiful interface.</p>
    </div>
  );
}
