      ...
      <div className="w-full lg:w-1/2 h-[50vh] lg:h-screen flex items-center justify-center lg:justify-start pointer-events-none z-20 lg:pl-10">
        ...
        >
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black tracking-tight mb-2" style={{ color: 'white' }}>Welcome Back</h1>
            <p className="text-sm font-medium" style={{ color: '#94a3b8' }}>Enter your credentials to securely access the dashboard.</p>
          </div>
