    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#F4F7F6]">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 text-sm mt-2 font-medium">Join us to get access to the admin portal.</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm font-medium text-slate-500">
              ...
              <Link href="/admin/login" className="text-primary font-bold hover:underline transition-all">
                Sign In
              </Link>
            </p>
          </div>
